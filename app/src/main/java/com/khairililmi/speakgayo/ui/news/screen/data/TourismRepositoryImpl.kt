...
import com.khairililmi.speakgayo.ui.news.screen.model.FakeTourismDataSource
...
class TourismRepositoryImpl : TourismRepository {
    ...
    override fun getTourismById(id: Int): Tourism {
        return tourismList.find { it.id == id } ?: throw Exception("Tourism not found")
    }
